/*
* Example of Task Manager for Arduino
...
#define TIME_TO_EXECUTE_TASK1          1000   //time unit: ms
#define TIME_TO_EXECUTE_TASK2          800   //time unit: ms
#define TIME_TO_EXECUTE_TASK3          1600  //time unit: ms
#define TIME_TO_EXECUTE_TASK4          3000  //time unit: ms
...
//Function: Task 1 function. It blinks a PIN13 led
//Params: nothing
//Return: nothing
void Task1(void)
{
    StateLedPin13 = (~StateLedPin13) & 0x01;          
    digitalWrite(13, StateLedPin13);
}

//Function: Task 2 function. It blinks a PIN9 led
//Params: nothing
//Return: nothing
void Task2(void)
{
    StateLedPin9 = (~StateLedPin9) & 0x01;          
    digitalWrite(9, StateLedPin9);    
}

//Function: Task 3 function.  It blinks a PIN8 led 
//Params: nothing
//Return: nothing
void Task3(void)
{
    StateLedPin8 = (~StateLedPin8) & 0x01;          
    digitalWrite(8, StateLedPin8);
}

//Function: Task 4 function. It sends a message over serial
//Params: nothing
//Return: nothing
void Task4(void)
{
    Serial.write("Hello! This message was sent by Task Manager\r\n");
}

void setup()
{
    //set pin´s direction and force all of them to 0 state
    pinMode(13, OUTPUT);
    pinMode(9, OUTPUT);    
    pinMode(8, OUTPUT);
    ...
    digitalWrite(13, StateLedPin13);
    digitalWrite(9, StateLedPin8);
    digitalWrite(8, StateLedPin9);
