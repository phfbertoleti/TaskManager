...
/* 0xFF7FFFE8 - 0xFF7FFFEF : UB Code A register  
   ...
   0xFF7FFFF8 - 0xFF7FFFFB : MDES register
...
const uint32_t user_boot_settings[6] = 
{
    ...
    ub_reset_vect   //This is the User Boot Reset Vector. If you are using User Boot then put in the reset address here. 
};
#else
/* Use this array if you are NOT using User Boot. */
const uint32_t user_boot_settings[6] = 
{
    0xFFFFFFFF,     //Required setting for UB Code A to get into User Boot
    0xFFFFFFFF,     //Required setting for UB Code A to get into User Boot
    0xFFFFFFFF,     //Required setting for UB Code B to get into User Boot
    0xFFFFFFFF,     //Required setting for UB Code B to get into User Boot
    0xFFFFFFFF,     //Select Little Endian for User Boot Code (0x00000000 for Big E., 0x00000007 for Little E)
    0xFFFFFFFF      //This is the User Boot Reset Vector. If you are using User Boot then put in the reset address here. 
};
#endif
